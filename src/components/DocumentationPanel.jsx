  ...
  return (
    <section className="panel bottom-panel">
      ...
      <div className="doc-copy">
        ...
        <p>Use <code>Import</code> and <code>Export</code> in the header to bring in or download <code>.asm</code> files. A small dot on an editor tab means that file has changes that have not been assembled or exported yet.</p>
